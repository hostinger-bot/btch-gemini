...
export async function gemini_chat(prompt: string): Promise<unknown> {
  if (!prompt) {
...
export async function gemini_image(prompt: string, imageUrl: string): Promise<unknown> {
  if (!prompt) {
    throw new Error('Prompt cannot be empty');
  }
...
export async function gemini_audio(audioUrl: string, prompt: string | null = null): Promise<unknown> {
  if (!audioUrl) {
...
export async function gemini_video(videoUrl: string, prompt: string | null = null): Promise<unknown> {
  if (!videoUrl) {
...
export async function gemini_history(messages: Message[]): Promise<unknown> {
...
export async function gemini_prompt(systemPrompt: string, query: string): Promise<unknown> {
  if (!systemPrompt) {
...
export async function gemini_imgedit(prompt: string, imageUrl: string, method: 'GET' | 'POST' = 'POST'): Promise<Buffer> {
  if (!prompt) {
    throw new Error('Prompt cannot be empty');
  }
