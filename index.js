 ...
 * @remarks
 * - Imports `gemini_chat`, `gemini_image`, `gemini_audio`, `gemini_video`, `gemini_history`, and `gemini_prompt` functions to make them available for use in other parts of the project.
